    ...
    return (
        (t.init = function(e, t) {
            ...
            "auto" === o.opt.slidesToScroll &&
                ...
                (o.itemWidth = o.opt.exactWidth ?
                    o.opt.itemWidth :
                    o.containerWidth / o.opt.slidesToShow), [].forEach.call(o.slides, function(e) {
                    (e.style.height = "auto"),
        ...
        (t.updateControls = function(e) {
            ...
            1 === Math.floor(d.opt.slidesToShow) && (h = 0),
                ...
                (d.page = d.dots ? d.dots.children.length - 1 : 0), [].forEach.call(d.slides, function(e, t) {
                    var o = e.classList,
        ...
        (t.destroy = function() {
            ...
            e(o), [].forEach.call(o.getElementsByTagName("*"), e),
